                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="input-group mb-3 col-sm-12">
                                <input type="text" name="text" id="miembroid" class="form-control form-control-sm"
                                    placeholder="Escriba para buscar (ej. Juan)" aria-label="Recipient's username"
                                    aria-describedby="button-addon2">
                                <div class="input-group-append">
                                    <button class="btn btn-dark btn-sm buscarmiembro" type="submit" id="button-addon2"> <i
                    ...
                    <form class="form-horizontal" action="{{ route('admin.usuarios.store') }}" method="POST">
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary btn-submit" id="btn-save" value="create">Guardar
                                Cambios
                            </button>
                        </div>
                    </form>
